...
// Plan
$_['plan_title']                                     = 'Razorpay Plan';
$_['plan_name']                                       = 'Plan Name';
...
$_['text_client_id_help']                               = 'Get this from the Manage Application page on Razorpay Subscription';
$_['text_client_id_label']                              = 'Razorpay Subscription Application ID';
$_['text_client_id_placeholder']                        = 'Razorpay Subscription Application ID';
$_['text_client_secret_help']                           = 'Get this from the Manage Application page on Razorpay Subscription';
...
$_['text_connected_info']                               = "Reconnect if you want to switch accounts or have manually revoked this extension's access from the Razorpay Subscription App console. Manually refresh the access token if it has been close to 45 days since the last sale or reconnect.";
$_['text_connection_section']                           = 'Razorpay Subscription Connection';
...
$_['text_edit_heading']                                 = 'Edit Razorpay Subscription';
...
$_['text_location_help']                                = 'Select which configured Razorpay Subscription location to be used for transactions. Has to have card processing capabilities enabled.';
$_['text_location_label']                               = 'Location';
$_['text_manage']                                       = 'Credit Card Transaction (Razorpay Subscription)';
...
$_['text_no_appropriate_locations_warning']             = 'There are no locations capable of online card processing setup in your Razorpay Subscription account.';
...
$_['text_not_connected_info']                           = 'By clicking this button you will connect this module to your Razorpay Subscription account and activate the service.';
...
$_['text_redirect_uri_label']                           = 'Razorpay Subscription OAuth Redirect URL';
$_['text_refresh_access_token_success']                 = 'Successfully refreshed the connection to your Razorpay Subscription account.'; 
...
$_['text_sandbox_access_token_help']                    = 'Get this from the Manage Application page on  Razorpay Subscription';
$_['text_sandbox_access_token_label']                   = 'Sandbox Access Token';
$_['text_sandbox_access_token_placeholder']             = 'Sandbox Access Token';
$_['text_sandbox_client_id_help']                       = 'Get this from the Manage Application page on Razorpay Subscription';
...
$_['text_sandbox_section_heading']                      = 'Razorpay Subscription Sandbox Settings';
$_['text_select_location']                              = 'Select location';
$_['text_settings_section_heading']                     = 'Razorpay Subscription Settings';
$_['text_razorpay_subscription']                                     = '<a target="_BLANK" href="https://razorpay.com"><img src="view/image/payment/razorpay.png" alt="Razorpay Subscription" title="Razorpay Subscription" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_success']                                      = 'Success: You have modified Razorpay Subscription payment module!';
...
$_['text_token_expired']                                = 'Your Razorpay Subscription access token has expired! <a href="%s">Click here</a> to renew it now.';
$_['text_token_expiry_warning']                         = 'Your Razorpay Subscription access token will expire on %s. <a href="%s">Click here</a> to renew it now.';
$_['text_token_revoked']                                = 'Your Razorpay Subscription access token has expired or has been revoked! <a href="%s">Click here</a> to re-authorize the Razorpay Subscription extension.';
